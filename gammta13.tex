...
\section{Optimal Control of ADAEs}
...
\begin{itemize}
	...
	\item[c.)] the (adDAE) have a solution,
...
\end{block}
\begin{theorem}
	If Assumption 1 holds, then the optimal control problem has a locally unique solution. This solution can be approached by Newton's method for the nonlinear optimality system. 
\end{theorem}
}
...
\begin{align*}
	...
	\dot \PHdf v(t)  - \PHpdf A\bigl(v\sdf(t) -jJ_1S^{-1}g(t)\bigr)  = \PHpdf f(t) & \text{ in }\Hdf'.
\end{align*}
